...
<!--                </ul> -->
   ...
   <div class='aclist' align="center">
	<ul class='widget_ul'>
		...
		%>
			<div class='widget'>
					<div class='widget__photo'><img src="img/no<%=listCount %>.png" width=50px height=50px align=left></div>
					<a href="main.jsp?mode=2&name=<%=d.getAc_name() %>"><div class='widget__button'>
					...
					<div class='widget__details'>
						...
						<div class='widget__badges'>
							<div class='widget__badge widget__badge--rating'>4.3</div>
							
						</div>
						<div class='widget__name'>
							<td class="detail" id="name_detail"><i class="fa fa-building-o" aria-hidden="true"></i>&nbsp;&nbsp;<%=d.getAc_name() %></td>
						</div>
						...
						<div class='widget__info'>
							<span><i class="fa fa-map-marker" aria-hidden="true"></i>&nbsp;&nbsp;
								<td class="detail" id="add_detail"><%=d.getAc_address()%></td>
							</span> 
							<span><i class="fa fa-phone" aria-hidden="true"></i>&nbsp;&nbsp;
								<td class="detail" id="tel_detail"><%=d.getAc_tel() %></td>
							 </span>
							 
						</div>
					</div>
						<c:set var="list" value="<%=d.getAc_name() %>"/>
		...
		<td align="right" valign="bottom">
         <a id="prev" href="main.jsp?mode=1&page=<%=curpage>1?curpage-1:curpage%>&search=<%=search%>">◀</a>&nbsp;
         <a id="next" href="main.jsp?mode=1&page=<%=curpage<totalpage?curpage+1:curpage%>&search=<%=search%>" >▶</a>&nbsp;&nbsp;
         <%=curpage %> / <%=totalpage %>
        </td>
	</div>
