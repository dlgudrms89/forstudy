			...
			<table id="table_content">
				<tr>
					<td align=right><a href="boardlist.do?page=1"> <img
							...
							<a href="boardlist.do?page=${curpage>1?curpage-1:curpage }">
...
<img src="img/ad2.gif" style="position:fixed; right:20px; top:365px; height:550px; cursor:pointer;" onclick="window.open('http://promotion.gmarket.co.kr/planview/plan.asp?sid=144415')">
