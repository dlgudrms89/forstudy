	...
	<div class="content-back">
		<center>
			...
			<table id="table_content">
				<form method="post" action="boardinsertok.do">
					<tr>
						<td class="tdcenter" width=20%>이름</td>
						<td class="tdcenter" width=30%><input type="text" name="id"
							value="${sessionScope.id }"></td>
						<td class="tdcenter" width=20%>비밀번호</td>
						<td class="tdcenter" width=30%><input type="password"
							size="15" id="boardpwd" name="pwd"></td>
					</tr>
					<tr>
						<td class="tdcenter" width=20%>제목</td>
						<td class="tdleft" colspan="3"><input type="text" size=60
							id="boardsubject" name="subject"></td>
					</tr>
					<tr>
						<td class="tdleft" colspan="4" valign="top" height="100" border=1>
							내용 <textarea rows="10" cols="60" id="boardcontent" name="content"></textarea>
							<pre></pre>
						</td>
					</tr>
					<tr>
