...
<!-- 				<div class="logo"> -->
					<a href="firstpage.do"><img src="img/simplelogo.png" border="0" width=100%
...
<!-- 			<div class="logo-shadow"></div> -->
		...
		<section>
		 <jsp:include page="member/mainlogin.jsp"></jsp:include>
	   	</section>
		<section>
			<div id="search_news">
				<ul>
					<a href="main.do"><li class="menu__search_news"><i class="fa fa-home fa-lg" aria-hidden="true"></i>&nbsp;&nbsp;홈
						</li></a>
					<a href="search.do"><li class="menu__search_news"><i class="fa fa-search"></i>&nbsp;&nbsp;학원
						검색</li></a>
					<a href="newsList.do"><li class="menu__search_news"><i class="fa fa-newspaper-o"></i>&nbsp;&nbsp;교육
						뉴스</li></a>
					<a href="gallery.do"><li class="menu__search_news"><i class="fa fa-photo"></i>&nbsp;&nbsp;갤러리</li></a>
				</ul>
			</div>
		</section>
		...
		<section>
			<div class="menu__wrap">
				...
				<ul data-menu="submenu-3-1" class="menu__level">
					<li class="menu__item"><a class="menu__link" href="boardlist.do">학생
							게시판</a></li>
					<li class="menu__item"><a class="menu__link" href="boardlist.do">학부모
							게시판</a></li>
					<li class="menu__item"><a class="menu__link" href="boardlist.do">익명게시판</a></li>
				</ul>
				<!-- Submenu 3-2 -->
				...
				<ul data-menu="submenu-4" class="menu__level">
					<li class="menu__item"><a class="menu__link"
						data-submenu="submenu-4-1" href="boardlist.do">일반</a></li>
					<li class="menu__item"><a class="menu__link"
						data-submenu="submenu-4-2" href="boardlist.do">취미</a></li>
				</ul>
				<!-- Submenu 4-1 -->
				<ul data-menu="submenu-4-1" class="menu__level">
					<li class="menu__item"><a class="menu__link" href="boardlist.do">공무원학원</a></li>
					<li class="menu__item"><a class="menu__link" href="boardlist.do">어학</a></li>
					<li class="menu__item" onclick="location.href='boardlist.do';"><a class="menu__link" href="boardlist.do">IT</a></li>
					<li class="menu__item"><a class="menu__link" href="boardlist.do">자격증</a></li>
					<li class="menu__item"><a class="menu__link" href="boardlist.do">익명게시판</a></li>
				</ul>
				<!-- Submenu 4-2 -->
				<ul data-menu="submenu-4-2" class="menu__level">
					<li class="menu__item"><a class="menu__link" href="boardlist.do">댄스</a></li>
					<li class="menu__item"><a class="menu__link" href="boardlist.do">음악</a></li>
					<li class="menu__item"><a class="menu__link" href="boardlist.do">요리</a></li>
					<li class="menu__item"><a class="menu__link" href="boardlist.do">DIY</a></li>
					<li class="menu__item"><a class="menu__link" href="boardlist.do">익명게시판</a></li>
				</ul>
			</div>
			</section>
			<div class="social-buttons">
			<a onclick="window.open('https://www.facebook.com/포스터디닷컴-507719639418391/?fref=ts')" class="social-button facebook" style="cursor:pointer"><i class="fa fa-facebook"></i></a>
			<a onclick="showPopup()" class="social-button twitter" style="cursor:pointer"><i class="fa fa-heart-o"></i></a>
</div>
		</nav>
